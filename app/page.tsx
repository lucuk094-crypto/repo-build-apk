      ...
      <header className="w-full max-w-xl mx-auto flex justify-between items-center mb-12 mt-4 px-2">
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="font-bold text-lg tracking-tight leading-none">Easy App Builder</span>
            ...
            >
              <div className="px-2 text-center">
                ...
                <p className="text-sm text-gray-600 font-medium max-w-sm mx-auto">
                  Dengan mudah, integrasikan situs web responsif apa pun ke dalam aplikasi Android & iOS yang canggih dengan mulus. Tanpa perlu coding.
                </p>
              </div>
              ...
              <div className="bg-surface rounded-3xl p-6 md:p-8 shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-border mt-4">
                ...
                <div className="mt-8 text-center flex flex-col items-center">
                   ...
                   <div className="text-sm font-black text-primary tracking-tight">VANXDEV FORUM</div>
                </div>
              </div>
